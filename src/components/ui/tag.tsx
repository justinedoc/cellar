function Tag({ children }: { children: React.ReactNode }) {
  return (
    <div className="border-foreground/10 hover:border-foreground/15 mx-auto flex w-max cursor-pointer items-center gap-2.5 rounded-full border py-1 pr-1 pl-2 backdrop-blur-lg select-none">
